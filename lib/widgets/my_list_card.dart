...
import 'package:expiry_tracker/utils/app_utils.dart';
import 'package:expiry_tracker/utils/custom_text_style.dart';
import 'package:expiry_tracker/utils/custom_widgets.dart';
import 'package:expiry_tracker/widgets/expiry_indicator.dart';
...
class MyListCard extends StatelessWidget {
  ...
  const MyListCard({super.key, required this.item, required this.box});
