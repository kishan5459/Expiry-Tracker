...
import 'package:expiry_tracker/widgets/sliding_button.dart';
import 'package:expiry_tracker/screens/dash_board_screen.dart';
...
class _GetStartedScreenState extends State<GetStartedScreen> {
  ...
  Future<void> saveName() async {
    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder:
            (context) => DashBoardScreen(userName: _nameController.text.trim()),
      ),
    );
  }
